...
// 1. Import the LoaderOverlay component
...
function CourseInfo({ courseData, viewCourse }) {
  ...
  async function generateCourseContentHandler() {
    try {
      ...
      setIsLoading(false);
      console.log(e);
      toast.error("Server Side Error, Try Again!"); // Changed to toast.error for better feedback
    }
  }
  return (
    <>
      {/* 2. Add the LoaderOverlay component here, connected to the isLoading state */}
      ...
      <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-10 lg:shadow lg:p-8">
        ...
        <div className="flex flex-col gap-6 w-full ">
          ...
          <div className="flex flex-col sm:flex-row sm:flex-wrap gap-4 text-sm">
            ...
            <div className="flex items-center gap-3 border shadow p-4 rounded-md w-full sm:w-[48%] lg:w-auto">
              ...
              <div>
                ...
                <p className="text-neutral-700 dark:text-neutral-600">
                  {courseList?.chapters[0]?.duration
                    ? `${courseList?.chapters[0].duration}s`
                    : "Not available"}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 border shadow p-4 rounded-md w-full sm:w-[48%] lg:w-auto">
              ...
              <div>
                ...
                <p className="text-neutral-700 dark:text-neutral-600">
                  {courseData?.noOfChapters || "Not available"}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 border shadow p-4 rounded-md w-full sm:w-[48%] lg:w-auto">
              ...
              <div>
                ...
                <p className="text-neutral-700 dark:text-neutral-600">
                  {courseList?.level || "Not available"}
                </p>
              </div>
            </div>
          </div>
          {!viewCourse ? (
            <Button
              disabled={isLoading}
              onClick={generateCourseContentHandler}
              className={"items-center flex w-fit p-6 cursor-pointer mx-auto md:mx-0 md:w-xs md:p-0 "}
            >
              {isLoading ? (
            ...
            <Link href={"/course/" + courseData?.cid}>
              <Button>
